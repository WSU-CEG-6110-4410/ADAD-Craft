...
/*!
    Minecraft units:
        Blocks - Singular unit of Minecraft world.
        Chunk Section - 16 x 16 area of blocks.
        Chunk - 16 x 16 x 256 area of blocks which extends from bedrock to the sky.
    [Reference](https://docs.overviewer.org/en/latest/design/designdoc/#:~:text=A%20chunk%20is%20therefore%20a,chunks%20is%20called%20a%20region.)
    [Issue #87](https://github.com/WSU-CEG-6110-4410/ADAD-Craft/issues/87)
!*/
